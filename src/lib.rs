...
pub trait Interface {
    ...
    fn send_parameters_iter<T: IntoIterator<Item = u8>>(
        &mut self,
        command: u8,
        data: T,
    ) -> Result<(), Self::Error>;
    /// Read parameters into an iterator
    fn read_parameters_iter<'l, T: IntoIterator<Item = &'l mut u8>>(
        &mut self,
        command: u8,
        data: T,
    ) -> Result<(), Self::Error>;
    ...
    Iface: Interface,
{
    ...
    */
    ...
    /**
        ...
        frame Write.
    */
    pub fn memory_write_iter<T: IntoIterator<Item = u8>>(
        &mut self,
        d: T,
    ) -> Result<(), Iface::Error> {
    ...
    */
    ...
    /**
        ...
        sends another command.
    */
    pub fn memory_read_iter<'l, T: IntoIterator<Item = &'l mut u8>>(
        &mut self,
        d: T,
    ) -> Result<(), Iface::Error> {
    ...
    */
    ...
    /**
        ...
        exceeding data will be written into the following column and page.
    */
    pub fn write_memory_continue_iter<T: IntoIterator<Item = u8>>(
        &mut self,
        d: T,
    ) -> Result<(), Iface::Error> {
    ...
    */
    ...
    /**
        ...
        This command makes no change to the other driver status.
    */
    pub fn read_memory_continue_iter<'l, T: IntoIterator<Item = &'l mut u8>>(
        &mut self,
        d: T,
    ) -> Result<(), Iface::Error> {
